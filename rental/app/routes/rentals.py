...
def create_rental():
    ...
    try:
        ...
        # Визначаємо період кінця як останній день місяця оренди
        ...
        # Пошук існуючого запису FinancialSummary
...
def cancel_rental(rental_id):
    ...
    # Перевірка прав доступу: власник оренди або адміністратор
    user = User.query.get(user_id)
...
def get_rentals():
    ...
    # Адміністратори бачать всі оренди, користувачі - лише свої
    if user.is_admin:
