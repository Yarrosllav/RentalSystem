...
def update_profile():
    ...
    if phone is not None:  # Дозволяє встановити phone на None
        user.phone = phone
...
def get_all_users():
    """
    Отримати список всіх користувачів. Доступно лише для адміністраторів.
    """
...
def get_user(user_id):
    """
    Отримати інформацію про конкретного користувача за його ID. Доступно лише для адміністраторів.
    """
    user = User.query.get(user_id)
    if not user:
        logger.warning(f"User not found with ID: {user_id}")
...
def update_user(user_id):
    """
    Оновити інформацію про конкретного користувача. Доступно лише для адміністраторів.
    """
    user = User.query.get(user_id)
    if not user:
        logger.warning(f"User not found with ID: {user_id}")
...
def delete_user(user_id):
    """
    Видалити користувача за його ID. Доступно лише для адміністраторів.
    """
    user = User.query.get(user_id)
    if not user:
        logger.warning(f"User not found with ID: {user_id}")
...
def make_admin(user_id):
    """
    Призначити користувача адміністратором. Доступно лише для адміністраторів.
    """
    user = User.query.get(user_id)
    if not user:
        logger.warning(f"User not found with ID: {user_id}")
...
def revoke_admin(user_id):
    """
    Відмінити права адміністратора у користувача. Доступно лише для адміністраторів.
    """
    user = User.query.get(user_id)
    if not user:
        logger.warning(f"User not found with ID: {user_id}")
