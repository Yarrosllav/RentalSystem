...
def add_asset():
    """
    Створити новий об'єкт оренди. Доступно лише для адміністраторів.
    """
    ...
    # Перевірка, чи існує користувач (адміністратор)
    ...
    new_asset = Asset(
        ...
        status='Доступно',  # Встановлюємо статус за замовчуванням
        price_per_day=price_per_day,
        user_id=user_id  # Встановлюємо як адміністратор
    )
    try:
    ...
    return jsonify({"msg": "Asset added successfully", "id": new_asset.id}), 201  # Заміна "asset_id" на "id"

@objects_bp.route('/', methods=['GET'])
@jwt_required()
def get_assets():
    """
    Отримати список об'єктів оренди. Адміністратори бачать всі об'єкти, користувачі - тільки доступні.
    """
    ...
    assets_data = [{
        "id": asset.id,  # Заміна "asset_id" на "id"
        "name": asset.name,
        "type": asset.type,
...
def get_asset(asset_id):
    """
    Отримати деталі об'єкта оренди за його ID. Доступно для всіх зареєстрованих користувачів.
    """
...
def update_asset(asset_id):
    """
    Оновити інформацію про об'єкт оренди. Доступно лише для адміністраторів.
    """
...
def delete_asset(asset_id):
    """
    Видалити об'єкт оренди. Доступно лише для адміністраторів.
    """
...
def set_maintenance(asset_id):
    """
    Встановити статус об'єкта оренди на 'На обслуговуванні'. Доступно лише для адміністраторів.
    """
...
def set_available(asset_id):
    """
    Встановити статус об'єкта оренди на 'Доступно'. Доступно лише для адміністраторів.
    """
