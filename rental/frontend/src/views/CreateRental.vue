<!-- src/components/CreateRental.vue -->
...
export default {
  ...
  methods: {
    ...
    async fetchAssetDetails() {
      try {
        // Використання інтерцептора Axios для додавання Authorization заголовка
    ...
    async createRental() {
      ...
      try {
        ...
        // Відправка POST-запиту на '/rentals/' для створення оренди
